...
class ResNetBase(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.layer4(x)
        conv5_3 = x
        return conv3_3,conv4_22,conv5_3
...
class RefineSSD_Res(nn.Module):
    ...
    def forward(self, x, test=False):
        ...
        conv3_3,conv_4_22,conv_5_2 = self.base(x)
        arm_sources.append(conv3_3)
        arm_sources.append(conv_4_22)
        arm_sources.append(conv_5_2)
        x = conv_5_2
        '''
        conv4_3 ---->(1,512,40,40)
